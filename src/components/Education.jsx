  ...
  const educationData = [
    {
      ...
      school: "Galaxy School & College, Bera, Pabna",
      mascot: "📘",
      year: "2016 - 2017",
      achievements: ["GPA: 4.33", "Subject: Science"],
    },
    {
      degree: "Higher Secondary Certificate (HSC)",
      school: "Bera Govt College, Bera, Pabna",
      mascot: "📗",
      year: "2018 - 2020",
      achievements: ["GPA: 4.43", "Subject: Science"],
    },
    {
      degree: "Affiliated Dhaka University, Dhaka",
      school: "Hons Department of Zoology",
      mascot: "📕",
      year: "2020 - Present",
      achievements: ["GPA: Running", "Subject: Zoology"],
    },
  ];
