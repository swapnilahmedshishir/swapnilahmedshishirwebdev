...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    form.append("access_key", "a2674604-2c40-496c-bede-23e96cd36f5d"); // Replace with your Web3Forms access key
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">Wari, Dhaka-1203 </p>
                  </div>
                </div>
                <div className="flex items-center space-x-4">
                  <div className="bg-pink-500/10 p-3 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">(880) 1602555023 </p>
                  </div>
                </div>
              </div>
            </div>
