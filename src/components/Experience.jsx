  ...
  const experiences = [
    {
      ...
      period: "2021 - 2023",
      description:
        "Developed and customized WordPress websites for clients worldwide, ensuring tailored functionality, seamless design, and optimal performance.",
    },

    {
      icon: Layers,
      title: "Executive & Developer | Intern",
      company: " ISBAH IT,Dhaka",
      period: "2023 - 2024",
      description:
        "Led website and software development projects, ensuring high-quality results and client satisfaction. Managed teams, customized software solutions, and executed client strategies for seamless integration. Skilled in HTML, CSS, JavaScript, and MySQL to develop efficient applications. Maintained strong communication, delivering tailored functionality and exceeding project expectations.",
    },
    {
      icon: Code2,
      ...
      period: "2024 - Present",
      description:
        "Development and maintained user-friendly website while customizing features to meet client needs . Managed technical issues, resolved performance problems , and ensured seamless functionality across projects. Handled data management and integration between front-end and back-end systems to optimize workflows . Utilized JavaScript , React , MongoDB, MySQL , WordPress , Node.js and Express to build scalable, efficient web applications.",
    },
  ];
        ...
        <div className="relative container mx-auto px-4 py-24">
          ...
          <div className="flex flex-col items-center space-y-6 mb-16">
            ...
            <p className="text-sm md:text-lg text-gray-400 font-medium italic tracking-wide">
              &ldquo;Crafting stories, one milestone at a time...&ldquo;
            </p>
